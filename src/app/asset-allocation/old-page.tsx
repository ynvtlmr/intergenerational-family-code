...
//                   onChange={(e) =>
//                     onDataChange(idx, "targetAllocation", e.target.value)
//                   }
//                   InputProps={{
//                     style: { textAlign: "right" },
//                   }}
...
//                   onChange={(e) =>
//                     onDataChange(idx, "targetNetReturn", e.target.value)
//                   }
//                   InputProps={{
//                     style: { textAlign: "right" },
//                   }}
...
//         {data.map(
//           (
//             row: { type: unknown; band: unknown; sharpeRatioTarget: string },
//             idx: React.Key | null | undefined
//           ) => (
//             <TableRow key={idx}>
//               <TableCell>
...
//                   onChange={(newValue) =>
//                     onDataChange(idx, "sharpeRatioTarget", newValue)
//                   }
//                 />
//               </TableCell>
//               <TableCell align="right">
...
//       ...currentData,
//       { type: "", band: "", targetAllocation: 0, targetNetReturn: 0 },
//     ]);
//   };
...
//       ...currentData,
//       { type: "", band: "", sharpeRatioTarget: "" },
//     ]);
//   };

//   const deleteAssetRow = (idx: number) => {
//     setTableData((currentData) =>
//       currentData.filter((_, index) => index !== idx)
//     );
//   };
...
//             onDataChange={handleSharpeRatioChange}
//             onDeleteRow={deleteSharpeRatioRow}
//           />
//         </div>
//       </div>
//     </div>
